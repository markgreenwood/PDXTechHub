(function(module) {
  ...
  JobPost.fetchResults = function(searchparams, nextFunction) {
    ...
    var search_str = 'l=' + searchparams.city + ',or&radius=' + searchparams.radius + '&q=javascript&sort=&st=&jt=&start=&limit=50&fromage=&filter=&latlong=1&co=us&chnl=&userip=1.2.3.4&useragent=Mozilla/%2F4.0%28Firefox%29&v=2&format=json';
